              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form id="form-kategori" required role="form" method="post" action="{{ url('kategori') }}" onsubmit="setFormSubmitting()">
                      {!! csrf_field() !!}
                      <div class="box-body">
                        <div class="form-group {{ $errors->has('kategori') ? ' has-error' : '' }}">
                          ...
                          @endif
                          <input type="text" required name="kategori" class="form-control" id="kategori" placeholder="Kategori" value="{{ old('kategori') }}">
                        </div>
                        <div class="form-group">
                          <label for="name">Kepada</label>
                          
                          <input type="text"  name="kepada" class="form-control" id="kepada" placeholder="kepada">
                        </div>
                        <div class="form-group">
