              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form id="form-dosen" required role="form" method="post" action="{{ url('dosen') }}" onsubmit="setFormSubmitting()">
                      {!! csrf_field() !!}
                      <div class="box-body">
...
<!-- jQuery 2.1.4 -->
    ...
    <script type="text/javascript">
      ...
      var serialize = $('#form-dosen').serialize();
      ...
      window.onload = function() {
          window.addEventListener("beforeunload", function (e) {
              ...
              if (serialize==$('#form-dosen').serialize()) {
                  return undefined;
              }
