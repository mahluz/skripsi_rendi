                ...
                <!-- form start -->
                    <form id="form-surat_keluar" required role="form" method="post" action="{{ url('surat_keluar') }}" onsubmit="setFormSubmitting()" enctype="multipart/form-data">
                      ...
                      <div class="box-body">
                        ...
                        ?>
                          <select required name="id_kategori" class="form-control select2" data-placeholder="Pilih kategori" style="width: 100%;">
                        ...
                        <div class="form-group {{ $errors->has('dari') ? ' has-error' : '' }}">
                          ...
                          @endif
                          <input type="text" name="dari" class="form-control" id="dari" placeholder="dari instansi" value="{{ old('dari') }}">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text"  name="tembusan" class="form-control" id="tembusan" placeholder="tembusan" value="{{ old('tembusan') }}">
