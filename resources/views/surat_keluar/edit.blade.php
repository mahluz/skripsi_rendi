                ...
                <!-- form start -->
                    <!--<form id="form-surat_keluar" required role="form" method="post" action="{{ url('surat_keluar') }}" onsubmit="setFormSubmitting()" enctype="multipart/form-data"> -->
                      ...
                      <div class="box-body">
                            ...
                            <input type="hidden" name="id_kategori" class="form-control" id="kategori" placeholder="hal" value="{{ $surat_keluar->id_kategori }}">
                                              
                        <div class="form-group ">
                          <label for="name">Hal</label>
                         
                          <input type="text" name="hal" class="form-control" id="hal" placeholder="hal" value="{{ $surat_keluar->hal }}">
                        </div>
                        <div class="form-group {{ $errors->has('dari') ? ' has-error' : '' }}">
                          ...
                          @endif
                          <input type="text" name="dari" class="form-control" id="dari" placeholder="dari instansi" value="{{ $surat_keluar->dari }}">
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('isi') ? ' has-error' : '' }}">
                          ...
                          @endif
                         <textarea id="isi" name="isi" required class="form-control" rows="5" placeholder="Isi surat... "> {{ $surat_keluar->isi }}</textarea>
                        </div>
                        <div class="form-group">
                          <label for="tembusan">Tembusan</label>
                          
                          <input type="text"  name="tembusan" class="form-control" id="tembusan" placeholder="tembusan" value="{{ $surat_keluar->tembusan }}">
